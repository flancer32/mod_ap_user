 ...
 *
 * @namespace Fl32_Ap_User_Back_Process_User_Load
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_User_Back_Process_User_Load';
 ...
 * @constructs Fl32_Ap_User_Back_Process_User_Load.process
 * @memberOf Fl32_Ap_User_Back_Process_User_Load
 */
function Factory(spec) {
     ...
     * @param trx
     * @param {Number} userId
     * @returns {Promise<Fl32_Ap_User_Shared_Service_Data_User>}
     * @memberOf Fl32_Ap_User_Back_Process_User_Load
     */
    async function process({trx, userId}) {
         ...
         * @param trx
         * @param {Number} userId
         * @returns {Promise<Fl32_Ap_User_Shared_Service_Data_User|null>}
         */
